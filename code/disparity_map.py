...
H_L,H_R,norm_disp=cal_rectit_mat('1-cones')
mask_s=pickle.load(open('../data_pair/1_l_mask.txt','rb'))
...
cv2.imwrite('../result/1-cones_result_mask.png',cv2.cvtColor(mask_disp,cv2.COLOR_GRAY2RGB))
